...
def test_replace_ace_by_one_valid():
    """valid request with 1 or more 11 in the sequence, will replace the first occurence of a 11 in the sequence by a 1"""
...
def test_handle_aces_if_needed():
    """replaces A (11) by 1 if the score exceeds 21 and a 11 is in the cards with updated deck and score, otherwise return cards as is"""
...
def test_execute_turn_invalid():
    """expects 2 positional arguments"""
